                        ...
                        <div className="row  " >
                                ...
                                <div className="d-block d-lg-none text-white text-center">
                                    <div className="row px-3 py-5 mb-3">
                                        ...
                                        <div className="text-center">
                                            <Link className="nav-link zoom-button w-auto px-4 px-md-5  py-3 bg-danger fw-semibold mt-3" style={{ boxShadow: "0 0 25px rgb(255, 168, 168)" }} to='/allProducts'>
                                                VIEW MENU
                                            </Link>
                                        </div>
                                    </div>
                            ...
                            <div className="d-none d-lg-block col-lg-7   bg-light text-start   " >
                                <div className="row px-3  pt-5 mt-5 text-start">
                                    ...
                                    <div className="col-3 ">
                                        <Link className="text-center text-white nav-link zoom-button w-100 py-3 bg-danger fw-semibold mt-3  " style={{ boxShadow: "0 0 25px rgb(255, 168, 168)" }} to='/allProducts'>
                                            VIEW MENU
